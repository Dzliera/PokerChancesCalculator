...
using PokerChancesCalculator.lib.Classes.Combinations;
...
namespace PokerChancesCalculator
{
    ...
    public static class Data
    {
        ...
        /// as highest combination is stored. frequency of combiantion
        /// is number how many times we got that combination as highest 
        /// combination after checking all possible cardsets in concrete situation. 
        /// </summary>
        ...
        /// <summary>
        /// Extenshion method to cast int to Card
        /// </summary>
        public static Card ToCard(this int index)
        {
            int rank = index % RankCount;
            if (rank == 0) rank = 13;
            int suit = (index - rank) / RankCount + 1;
